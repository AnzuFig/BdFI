...
class DoubleListIterator<E> implements TwoWayIterator<E>
{
     ...
     */
    protected DoubleList.DoubleListNode<E> firstNode;

    /**
     * Node with the last element in the iteration.
     */
    protected DoubleList.DoubleListNode<E> lastNode;

    /**
     * Node with the next element in the iteration.
     */
    protected DoubleList.DoubleListNode<E> nextToReturn;

    /**
     * Node with the previous element in the iteration.
     */
    protected DoubleList.DoubleListNode<E> prevToReturn;
     ...
     */
    public DoubleListIterator( DoubleList.DoubleListNode<E> first, DoubleList.DoubleListNode<E> last )
    {
        firstNode = first;
        lastNode = last;
        this.rewind();
